package com.flexispot.ble.ota.ble;
...
public class BleNamesResolver {
    ...
    public final static String DEFAULT_CHARACTERISTIC_NAME = "Unknown Characteristic";
    static {
        ...
        mValueFormats.put(Integer.valueOf(52).intValue(), "32bit float");
        mValueFormats.put(Integer.valueOf(50).intValue(), "16bit float");
        mValueFormats.put(Integer.valueOf(34).intValue(), "16bit signed int");
        mValueFormats.put(Integer.valueOf(36).intValue(), "32bit signed int");
        mValueFormats.put(Integer.valueOf(33).intValue(), "8bit signed int");
        mValueFormats.put(Integer.valueOf(18).intValue(), "16bit unsigned int");
        mValueFormats.put(Integer.valueOf(20).intValue(), "32bit unsigned int");
        mValueFormats.put(Integer.valueOf(17).intValue(), "8bit unsigned int");
        mAppearance.put(Integer.valueOf(833).intValue(), "Heart Rate Sensor: Belt");
        mAppearance.put(Integer.valueOf(832).intValue(), "Generic Heart Rate Sensor");
        mAppearance.put(Integer.valueOf(0).intValue(), "Unknown");
        mAppearance.put(Integer.valueOf(64).intValue(), "Generic Phone");
        mAppearance.put(Integer.valueOf(1157).intValue(), "Cycling: Speed and Cadence Sensor");
        mAppearance.put(Integer.valueOf(1152).intValue(), "General Cycling");
        mAppearance.put(Integer.valueOf(1153).intValue(), "Cycling Computer");
        mAppearance.put(Integer.valueOf(1154).intValue(), "Cycling: Speed Sensor");
        mAppearance.put(Integer.valueOf(1155).intValue(), "Cycling: Cadence Sensor");
        mAppearance.put(Integer.valueOf(1156).intValue(), "Cycling: Speed and Cadence Sensor");
        mAppearance.put(Integer.valueOf(1157).intValue(), "Cycling: Power Sensor");
        mHeartRateSensorLocation.put(Integer.valueOf(0).intValue(), "Other");
        mHeartRateSensorLocation.put(Integer.valueOf(1).intValue(), "Chest");
        mHeartRateSensorLocation.put(Integer.valueOf(2).intValue(), "Wrist");
        mHeartRateSensorLocation.put(Integer.valueOf(3).intValue(), "Finger");
        mHeartRateSensorLocation.put(Integer.valueOf(4).intValue(), "Hand");
        mHeartRateSensorLocation.put(Integer.valueOf(5).intValue(), "Ear Lobe");
        mHeartRateSensorLocation.put(Integer.valueOf(6).intValue(), "Foot");
    }

    public static boolean isCharacteristic(String paramString) {
        return mCharacteristics.containsKey(paramString);
    }

    public static boolean isService(String paramString) {
        return mServices.containsKey(paramString);
    }

    public static String resolveAppearance(int paramInt) {
        Integer localInteger = Integer.valueOf(paramInt);
        return (String) mAppearance.get(localInteger.intValue(), "Unknown Appearance");
    }

    public static String resolveCharacteristicName(String paramString) {
        String str = (String) mCharacteristics.get(paramString);
        if (str == null)
            str = DEFAULT_CHARACTERISTIC_NAME;
        return str;
    }

    public static String resolveHeartRateSensorLocation(int paramInt) {
        Integer localInteger = Integer.valueOf(paramInt);
        return (String) mHeartRateSensorLocation.get(localInteger.intValue(), "Other");
    }

    public static String resolveServiceName(String paramString) {
        String str = (String) mServices.get(paramString);
        if (str == null)
            str = "Unknown Service";
        return str;
    }

    public static String resolveUuid(String paramString) {
        String str1 = (String) mServices.get(paramString);
        if (str1 != null)
            return "Service: " + str1;
        String str2 = (String) mCharacteristics.get(paramString);
        if (str2 != null)
            return "Characteristic: " + str2;
        return "Unknown UUID";
    }

    public static String resolveValueTypeDescription(int paramInt) {
        Integer localInteger = Integer.valueOf(paramInt);
        return (String) mValueFormats.get(localInteger.intValue(), "Unknown Format");
    }
}
