 ...
 */
class DeviceDetailActivity : BaseActivity(), View.OnClickListener {
...
fun getData(){
    ...
    if (activity == 1) {
        val ac =
            LumanHelper.aboutActivityManager().findAc(RackActivity::class.java.name)
        ViewModelProviders.of(ac!!).get(MediaViewModel::class.java).sendData(MediaData.GetVersion())
        ViewModelProviders.of(ac!!).get(MediaViewModel::class.java)
        ...
        val ac =
            LumanHelper.aboutActivityManager().findAc(MediaActivity::class.java.name)
        ViewModelProviders.of(ac!!).get(MediaViewModel::class.java).sendData(MediaData.GetVersion())
        ViewModelProviders.of(ac!!).get(MediaViewModel::class.java)
            .openreset.observe(this, Observer {
            if (it){
