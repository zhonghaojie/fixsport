...
//    private BluetoothGattCharacteristic mOTAGattCharacteristic;
    ...
    public void setGattOperationCallback (GattOperationCallback callback){
        this.mGattOperationCallback=callback;
    }
...
//        this.sendOtaStartCommand();
    ...
    public void setData(Command cmd, byte[] data){
        cmd.serviceUUID =UUID.fromString("0000180d-0000-1000-8000-00805f9b34fb") ;
        cmd.characteristicUUID = UUID.fromString("00002a39-0000-1000-8000-00805f9b34fb") ;
//        cmd.descriptorUUID = UUID.fromString("00002a37-0000-1000-8000-00805f9b34fb") ;
        cmd.type = Command.CommandType.WRITE;
        cmd.tag = TAG_GENERAL_WRITE;
        cmd.data = data;
        this.sendCommand(mCharacteristicCommandCallback, cmd);
    }
